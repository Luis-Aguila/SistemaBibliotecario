                       ...
                       <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    %>
                                    <th scope="row"><%out.println(rsbusqueda.getString("id_libro"));%></th>
                                    <td><%out.println(rsbusqueda.getString("nombre_libro"));%></td>
                                    <td><%out.println(rsbusqueda.getString("nombre_autor"));%></td>
                                    <td><%out.println(rsbusqueda.getString("nombre_editorial"));%></td>
                                    <td><%out.println(rsbusqueda.getString("nombre_estadolibro"));%></td>
                                    <td></td>
                                    <td>
