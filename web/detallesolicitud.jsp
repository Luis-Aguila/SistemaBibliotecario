                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                           ...
                                           <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row"><%out.println(rutestudiante);%></th>
                                                        <th scope="row"><%out.println(nombreestudiante);%></th>
                                                        <th scope="row"><%out.println(apellidoestudiante);%></th>
                                                        <th scope="row"><%out.println(direccionestudiante);%></th>
                                                        <th scope="row"><%out.println(telefonoestudiante);%></th>
                                                        <th scope="row"><%out.println(anioestudio);%></th>
                                                        <th scope="row"><%out.println(carrera);%></th>
                                                        <th scope="row"><%out.println(estadoestudiante);%></th>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                                ...
                                                <div class="col-12">
                                                   ...
                                                   <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            %>
                                                            <tr>
                                                                <th scope="row"><%out.println(rsprespendientes2.getString("id_prestamo"));%></th>
                                                                <th scope="row"><%out.println(rsprespendientes2.getString("descripcion_prestamo"));%></th>
                                                                <th scope="row"><%out.println(rsprespendientes2.getString("nombre_libro"));%></th>
                                                                <th scope="row"><%out.println(rsprespendientes2.getString("nombre_autor"));%></th>
                                                                <th scope="row"><%out.println(rsprespendientes2.getString("nombre_editorial"));%></th>
                                                                <th scope="row"><%out.println(rsprespendientes2.getString("Usuario_rut_usuario"));%></th>
                                                                <th scope="row"><%out.println(mensaje);%></th>
                                                                <%
                                                                    if(dias > 0){
                                                                        %>
                                                                        <th scope="row"><%out.println(dias + " Semanas.");%></th>
                                                                        <%
                                                                    }else{
                                                                        %>
                                                                        <th scope="row"><%out.println("Sin castigo.");%></th>
                                                                        <%
                                                                    }
                                                                %>
                                                                
                                                                <th scope="row"><%out.println(rsprespendientes2.getString("nombre_estadoprestamo"));%></th>
                                                            </tr>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row"><%out.println(rutdocente);%></th>
                                                        <th scope="row"><%out.println(nombredocente);%></th>
                                                        <th scope="row"><%out.println(apellidodocente);%></th>
                                                        <th scope="row"><%out.println(direcciondocente);%></th>
                                                        <th scope="row"><%out.println(telefonodocente);%></th>
                                                        <th scope="row"><%out.println(estadodocente);%></th>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
