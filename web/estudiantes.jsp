                ...
                <body>
                    ...
                    <div class="container-fluid cuerpo-estudiantes">
                        <div class="container subcuerpo-estudiantes">
                            <div class="row">
                                <div class="col-12">
                                    <!--Tabla de estudiantes registrados como solicitantes-->
                                    <table class="table">
                                    ...
                                    %>
                                                    <th scope="row">
                                                        <%out.println(rsestudiante.getString("rut_estudiante"));%>
                                                    </th>
                                                    <td>
                                                        <%out.println(rsestudiante.getString("nombre_estudiante"));%>
                                                    </td>
                                                    <td>
                                                        <%out.println(rsestudiante.getString("apellido_estudiante"));%>
                                                    </td>
                                                    <td>
                                                        <%out.println(rsestudiante.getString("telefono_estudiante"));%>
                                                    </td>
                                                    <td>
                                                        <%out.println(rsestudiante.getString("nombre_carrera"));%>
                                                    </td>
                                                    <td>
                                                        <%out.println(rsestudiante.getString("nombre_estadoestudiante"));%>
                                                    </td>
                                                    <td></td>
                                                    <td>
