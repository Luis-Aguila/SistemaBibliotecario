                       ...
                       <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    %>
                                    <th scope="row"><%out.println(rslibro.getString("id_libro"));%></th>
                                    <td><%out.println(rslibro.getString("nombre_libro"));%></td>
                                    <td><%out.println(rslibro.getString("nombre_autor"));%></td>
                                    <td><%out.println(rslibro.getString("nombre_editorial"));%></td>
                                    <td><%out.println(rslibro.getString("nombre_estadolibro"));%></td>
                                    <td></td>
                                    <td>
