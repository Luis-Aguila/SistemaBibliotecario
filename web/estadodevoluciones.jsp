                    ...
                    <div class="col-12">
                       <table class="table">
                            ...
                            <tbody>
                                ...
                                %>
                                <tr>
                                    <th scope="row"><%out.println(rssolicitud.getString("id_prestamo"));%></th>
                                    <td><%out.println(rssolicitud.getString("descripcion_prestamo"));%></td>
                                    <td><%out.println(rssolicitud.getString("fechaentrega_prestamo"));%></td>
                                    <td><%out.println(rssolicitud.getString("fechaentregaestimada_prestamo"));%></td>
                                    <td><%out.println(rssolicitud.getString("fecharecepcion_prestamo"));%></td>
                                    <td><%out.println(rssolicitud.getString("id_arrendatario"));%></td>
                                    <td><%out.println(rssolicitud.getString("nombre_libro"));%></td>
                                    <td><%out.println(rssolicitud.getString("nombre_autor"));%></td>
                                    <td><%out.println(rssolicitud.getString("nombre_estadoprestamo"));%></td>
                                </tr>
                                <%}%>
                            </tbody>
                        </table>
