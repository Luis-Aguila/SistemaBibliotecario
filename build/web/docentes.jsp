                       ...
                       <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    %>
                                    <th scope="row"><%out.println(rsdocente.getString("rut_docente"));%></th>
                                    <td><%out.println(rsdocente.getString("nombre_docente"));%></td>
                                    <td><%out.println(rsdocente.getString("apellido_docente"));%></td>
                                    <td><%out.println(rsdocente.getString("telefono_docente"));%></td>
                                    <td><%out.println(rsdocente.getString("nombre_estadodocente"));%></td>
                                    <td></td>
                                    <td>
